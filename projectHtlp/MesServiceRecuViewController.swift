//
//  MesServiceRecuViewController.swift
//  projectHtlp
//
...
class MesServiceRecuViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do{
            ...
            requete2.predicate = NSPredicate(format: "userRecoit = %@", user)
            ...
            do {
                ...
                if resultats.count > 0 {
                    for resultat in resultats as! [NSManagedObject] {
                        ...
                        details.append(date.stringFromDate(resultat.valueForKey("date") as! NSDate))
    ...
    */
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> ServiceTableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Guy", forIndexPath: indexPath)as! ServiceTableViewCell

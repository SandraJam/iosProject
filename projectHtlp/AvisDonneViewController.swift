...
class AvisDonneViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do{
            ...
            requete.predicate = NSPredicate(format: "donneurAvis = %@", user)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = UITableViewCell(style: .Subtitle, reuseIdentifier: "Gilbert")
    ...
    func tableView(tableView: UITableView!, didSelectRowAtIndexPath indexPath: NSIndexPath!) {
        if let resultController = storyboard?.instantiateViewControllerWithIdentifier("avisView") as? AvisViewController {
            resultController.retour = "avisdonne"
